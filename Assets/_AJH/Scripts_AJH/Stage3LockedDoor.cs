...
{
    public class Stage3LockedDoor : MonoBehaviour
    {
        ...
        public XRKnob teacherDeskLockedDoor;
        public XRGrabInteractable flashLightGrab;
        public XRGrabInteractable knifeGrab;
        ...
        void Update()
        {
            if (numberKeyPad.isUnlocked == true && Locked)
            {
                Locked = false;
                teacherDeskLockedDoor.enabled = true;
                flashLightGrab.enabled = true;
                knifeGrab.enabled = true;
